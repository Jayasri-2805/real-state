...
export const PurchaseStatus = createMasterModel(
  'PurchaseStatus',
  {
    status_name: { type: String, required: true, trim: true },
    status_no: { type: String, required: true, trim: true },
    sort_order: { type: Number, default: 0 },
  },
  { uniqueWith: 'status_name' }
);

export const TaxMaster = createMasterModel(
  'TaxMaster',
  {
    tax_name: { type: String, required: true, trim: true },
    tax_percent: { type: Number, required: true, default: 0 },
    status: { type: String, default: 'Active' },
  },
  { uniqueWith: 'tax_name' }
);

export const OtherChargesMaster = createMasterModel(
  'OtherChargesMaster',
  {
    other_charges_master: { type: String, required: true, trim: true },
    required: { type: Boolean, default: false },
  },
  { uniqueWith: 'other_charges_master' }
);
...
export const ProductType = createMasterModel(
  ...
  { uniqueWith: 'product_type' }
);

export const PriorityMaster = createMasterModel(
  'PriorityMaster',
  {
    priority_name: { type: String, required: true, trim: true },
    color: { type: String, required: true, trim: true },
  },
  { uniqueWith: 'priority_name' }
);
...
export const MASTER_REGISTRY = {
  ...
  'purchase-status': { model: PurchaseStatus, label: 'Purchase Status' },
  'tax-masters': { model: TaxMaster, label: 'Tax Master' },
  'other-charges-master': { model: OtherChargesMaster, label: 'Other Charges Master' },
  'product-types': { model: ProductType, label: 'Product Type' },
  'priority-masters': { model: PriorityMaster, label: 'Priority Master' },
