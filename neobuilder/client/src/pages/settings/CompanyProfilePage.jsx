  ...
  return (
    <div className="page">
      <div style={{ fontSize: '14px', color: 'var(--text-muted)', marginBottom: '16px' }}>
        <span>Home</span> / <span style={{ color: 'var(--text)' }}>Company Profile</span>
      </div>
      ...
      <form className="table-card" onSubmit={handleSubmit}>
        <div className="modal-body" style={{ padding: '24px' }}>
          ...
          <label
            ...
            style={{
              display: 'flex', alignItems: 'center', gap: '20px', marginTop: '24px',
          ...
          >
            <div style={{ width: '120px', height: '120px', overflow: 'hidden' }}>
              <img
                src={company?.logo?.url ? getLogoUrl(company.logo.url) : defaultLogoUrl}
                alt="Company Logo"
                onError={(e) => {
            ...
            <div>
              ...
              <p style={{ fontSize: '12px', color: 'var(--text-muted)', marginTop: '8px', pointerEvents: 'none', margin: '8px 0 0 0' }}>
                Recommended size: 256x256. Max 2MB.
              </p>
            </div>
          </label>
        </div>
