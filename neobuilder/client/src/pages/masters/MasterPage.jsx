...
export default function MasterPage() {
  ...
  // groupItems removed from page header — navigation (sidebar) already shows these
  ...
  // Sync search state from `q` query param so header searches affect results
  useEffect(() => {
    const params = new URLSearchParams(location.search);
            ...
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  {showStatus && <th style={{ width: '120px' }}>Status</th>}
